...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Password',
        'HOST': 'database-2.ct6kq4048kie.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'blogggmy' # please enter your s3 bucket name
